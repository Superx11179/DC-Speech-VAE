# 🎤 DC-Speech-VAE - Compress Speech for Better Clarity
...
## 🎧 How to Use
After installation, you can start using DC-Speech-VAE:

1. Open the application from your desktop or start menu.
2. Click on **Import Audio** to choose the audio file you want to compress. Supported formats include .wav and .mp3.
3. Adjust the settings if necessary, but the default settings work well for most users.
4. Click on **Compress**. This process may take a few moments, depending on the file size.
5. Once complete, you will find the compressed audio file in the designated output folder.

## 📂 Features
- **5Hz Deep Compression:** Reduces file size while maintaining audio quality.
- **User-Friendly Interface:** Designed with simplicity in mind for easy navigation.
- **Multiple Format Support:** Works with common audio formats like .wav and .mp3.
- **Batch Processing:** Compress multiple audio files at once to save time.

## ⚙️ Troubleshooting
If you encounter issues, try the following:

- **Application won’t start:** Ensure your system meets the requirements. If using an unsupported OS, try running in compatibility mode.
- **Slow compression:** Close any unnecessary applications to free up system resources.
